...
public class KayttisTest extends FestSwingJUnitTestCase {
  ...
  /**
   * JFramesta tulee löytyä aluksi nappulat: Tauko, Uusi peli, Lopeta, Asetukset
   * ja Ennatyslista
   */
  @Test
  ...
  /**
   * Testaa onko nappuloiden aktiivisuudet aluksi oikein. (Jokainen nappula on
   * aktiivinen vain silloin kun siitä saa voida painaa.)
   */
  @Test
  ...
  /**
   * Testaa onko JFramessa olevien JButtonien aktiivisuudet (isEnabled)
   * haluttuja
   *
  ...
  /**
   * Testaa onko JButtonien aktiivisuudet oikein kun Asetukset-näppäintä on
   * klikattu
   */
  @Test
  ...
  /**
   * Testaa onko JButtonien aktiivisuudet oikein kun Ennatys-näppiäntä on
   * klikattu
   */
  @Test
  ...
  /**
   * Testaa onko JButtonien aktiivisuudet oikein kun Uusi peli-näppäintä on
   * klikattu
   */
  @Test
  ...
  /**
   * Testaa onko JButtonien aktiivisuudet oikein kun peli on laitettu tauolle
   * Tauko-näppäintä klikkaamalla
   */
  @Test
  ...
  /**
   * Testaa onko JButtonien aktiivisuudet oikein kun peli on lopetettu
   * Lopeta-näppäintä klikkaamalla
   */
  @Test
  ...
  /**
   * Testaa muuttuuko Tauko-näppäin Jatka-näppäimeksi kun peli on aloitettu ja
   * Asetukset-näppäintä klikataan
   */
  @Test
  ...
  /**
   * Testaa muuttuuko Tauko-näppäin Jatka-näppäimeksi kun peli on aloitettu ja
   * Ennatyslista-näppäintä klikataan
   */
  @Test
  ...
  /**
   * Testaa onko Tauko-näppäin yhä Tauko-näppäin kun peli on aloitettu ja se
   * lopetetaan
   */
  @Test
  ...
  /**
   * Testaa onko Tauko-näppäin yhä Tauko-näppäin kun pelin aikana klikataan Uusi
   * peli-näppäintä
   */
  @Test
  ...
  /**
   * Testaa onko Jatka-näppäin jälleen Tauko-näppäin jos tauon aikana klikataan
   * Uusi peli-näppäintä
   */
  @Test
