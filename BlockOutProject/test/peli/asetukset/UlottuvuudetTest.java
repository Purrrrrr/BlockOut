...
public class UlottuvuudetTest {
  ...
  /**
   * Käyttäjä ei saa voida asettaa kuilun leveydeksi liian pientä arvoa. Arvo
   * pysyy sinä mikä se ennen asetusta oli.
   */
  @Test
  ...
  /**
   * Käyttäjä ei saa voida asettaa kuilun leveydeksi liian suurta arvoa. Arvo
   * pysyy sinä mikä se ennen asetusta oli.
   */
  @Test
  ...
  /**
   * Käyttäjän ei tule voida asettaa liian pientä kuilun korkeutta. Arvo pysyy
   * sinä mikä se ennen asetusta oli.
   */
  @Test
  ...
  /**
   * Käyttäjän ei tule voida asettaa liian suurta kuilun korkeutta. Arvo pysyy
   * sinä mikä se ennen asetusta oli.
   */
  @Test
  ...
  /**
   * Käyttäjän ei tule voida asettaa liian suurta kuilun syvyyttä. Arvo pysyy
   * sinä mikä se ennen asetusta oli.
   */
  @Test
  ...
  /**
   * Käyttäjän ei tule voida asettaa kuilun seinien leikkauspistettä kuilun
   * pohjan etupuolelle.
   */
  @Test
  ...
  /**
   * Käyttäjän tulee voida asettaa kuilun seinien leikkauspiste kuilun pohjan
   * taakse.
   */
  @Test
  ...
  /**
   * Käyttäjän siirrettyä kuilun pohjaa leikkauspisteen taakse, leikkauspisteen
   * tulee siirtyä automaattisesti kuilun pohjan taakse.
   */
  @Test
  ...
  /**
   * Ulottuvuustallenne tulee olla avattavissa ja sen tulee asettaa ulottuvuudet
   * sen mukaiseksi.
   */
  @Test
  ...
  /**
   * Tallennetta avattaessa ulottuvuuksia ei tule asettaa liian suuriksi tai
   * liian pieniksi. (Kullakin ulottuvuuden parametrilla on omat ylä- ja
   * alarajansa.)
   */
  @Test
  ...
  /**
   * Tallenne, joka sisältää huonossa formaatissa olevaa tietoa, ei saa kaataa
   * ohjelmaa vaan siihen tulee varautua.
   */
  @Test
  ...
  /**
   * Tallenteisiin, joista puuttuu lukuarvoja, tulee varautua eivätkä ne saa
   * kaataa ohjelmaa.
   */
  @Test
