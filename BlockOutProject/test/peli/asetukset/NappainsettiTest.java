...
public class NappainsettiTest {
   ...
   * Tällöin ohjelman tulee asettaa alkuperäiset näppäimet vaikka osa
   * tallenteesta olisikin jo avattu ongelmitta.
   */
  @Test
  ...
  /**
   * Testataan varautuuko nappainsettitallenteen avaaja virheisiin tallenteen
   * muotoilussa. Tässä tapauksessa testataan miten merkkijono syötteet
   * käyttäytyvät kun niiden kohdilla tuli olla numeroita.
   */
  @Test
  ...
  /**
   * Ohjelman tulee tallentaa nappainsetti oikein, jotta sita voidaan myohemmin
   * lukea.
   */
  @Test
  ...
  /**
   * Ohjelman tulee asettaa alkuperäiset näppäimet jos nappainsettitallenteen
   * avauksessa ilmeni ongelmia.
   */
  @Test
  ...
  /**
   * Käyttäjän tulee voida asettaa toiminto näppäimelle, jolle ei ole vielä
   * asetettu muita toimintoja.
   */
  @Test
