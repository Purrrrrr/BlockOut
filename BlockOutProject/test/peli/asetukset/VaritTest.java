...
public class VaritTest {
  ...
  /**
   * Ohjelma antaa varit oikeassa jarjestyksessa kerros kerrallaan niin etta
   * listan ensimmainen vari tulee olemaan myos kerros 1.
   */
  @Test
  ...
  /**
   * Negatiivisen tai nollannen kerroksen varia pyydettaessa ohjelman tulisi
   * palauttaa harmaa.
   */
  @Test
  ...
  /**
   * Pyydettaessa sellaisen kerroksen varia, jonka kerrosnumero on suurempi kuin
   * varilistan koko kaydaan lista lapi niin monta kertaa, etta oikea kerros
   * loydetaan. Esimerkiksi listan ollessa 3 pitka ja kysytaan neljatta kerrosta
   * tulisi ohjelman palauttaa listan ensimmainen vari.
   */
  @Test
  ...
  /**
   * Ohjelman ei tule muuttaa mitaan jos yritetaan vaihtaa negatiivisen tai
   * nollannen kerroksen varia.
   */
  @Test
  ...
  /**
   * Ohjelman tulee osata lisata listaan vari jos vaihdetaan sen kerroksen vari,
   * joka on listan viimeisen varin jalkeen.
   */
  @Test
