...
public class Piste3DHakuTest {
  ...
  /**
   * Testaa onko syvemmalta ruudukosta pyydetyn ikkunakoordinaatit lahempaa
   * ikkunan keskipistetta.
   */
  @Test
  ...
  /**
   * Testaa onko ruudun toisesta laidasta pyydetyn kulman ikkunakoordinaatti
   * oikeassa suunnassa toiseen kulmaan nahden.
   */
  @Test
