...
public class KenttaTest {
  ...
  /**
   * Kentan edusta on tyhja kun edustan tayttanyt palikka on ollut koko kentan
   * levyinen ja korkuinen ja kerros on tuhottu.
   */
  @Test
  ...
  /**
   * Kun yksi kolmen korkea pala on tiputettu pohjalle varitettavia kerroksia on
   * kolme.
   */
