...
public class EnnatyslistaTest {
  ...
  /**
   * Testaa kielletaanko sellaiselta tulokselta listalle paasy, jolla on yhta
   * hyva tulos kuin listan viimeisella listasijalla
   */
  @Test
  ...
  /**
   * Testaa osataanko lista jarjestaa niin, etta getPieninPistemaara toimii
   * oikein ja niin ei esta muiden kuin pieninta pienempien tai yhta suurien
   * tulosten listalle lisaamisen.
   */
  @Test
