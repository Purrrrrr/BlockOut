...
public class AsetuksetPaneli extends JPanel implements KeyListener {
  ...
  /**
   * Nayttaa kayttajalle lahes kaikki peliin liittyvat asetukset ja antaa
   * kayttajan muokata niita.
   *
   * @param talletetutPaneli JPanel, joka sisaltaa kayttajan valittavissa olevat
   * asetussetti-JButtonit
   * @param valitutAsetukset Silla hetkella valittu asetussetti
   * @param muokattavissa Kertoo onko kaikki asetukset muokattavissa.
   * Perusasetuksien kaikkia asetuksia ei voi muokata
   */
  ...
  /**
   * Luo vaihtelevaan palstaan jalleen Taso-kyselyn ja paivittaa
   * UlottuvuudetPanelin.
   */
