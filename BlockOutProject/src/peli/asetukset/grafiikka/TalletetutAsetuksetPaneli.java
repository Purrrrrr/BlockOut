...
public class TalletetutAsetuksetPaneli extends JPanel {
  ...
  /**
   * Vaihtaa valittua asetusta kayttajan valintojen mukaisesti. Jos kayttaja on
   * valinnut entuudestaan tyhjan asetuksen luodaan uudelle asetukselle uusi
   * nappula tyhjan nappulan tilalle.
   *
  ...
  /**
   * Vaihtaa nappuloiden aktiivisuuksia niin, etta valittu nappula/asetus on
   * passiivinen ja muut aktiivisia, jotta ne voidaan valita.
   *
  ...
  /**
   * Vaihtaa valitun nappulan tekstin. Nain kay jos kayttaja vaihtaa tallennetun
   * asetussetin nimea.
   *
  ...
  /**
   * Antaa nappulalle uuden kuuntelijan. Kaytetaan kun tyhja nappula liitetaan
   * uuteen asetussettiin.
   *
  ...
  /**
   * Poistaa tietylta nappulalta liitetyt tapahtumakuuntelijat ja lisaa sille
   * uuden tapahtumakuuntelijan.
   *
  ...
  /**
   * Hakee fontin, jonka tietokoneen kayttojarjestelma tunnistaa. Tallentaa
   * fontin nimen luokan privaattiin muuttujaan.
   */
