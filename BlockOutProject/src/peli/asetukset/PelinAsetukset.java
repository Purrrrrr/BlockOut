...
public class PelinAsetukset extends Ikkuna {
  ...
  /**
   * Avaa tallennokset tiedostosta. Avauksen ollessa kaynnissa ohjelma ei
   * tallenna asetuksia aina kun jotain arvoa asetetaan.
   */
  ...
  /**
   * Antaa varin asetuksille jos Varipaletti ei nyt sitten anna sita suoraan
   * vareille.
   *
