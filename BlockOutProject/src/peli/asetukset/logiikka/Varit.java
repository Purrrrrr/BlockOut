...
public class Varit {
   ...
   *
   * @param kerros Kerros, jonka vari halutaan. Kerroksien numerointi alkaa
   * pohjalta.
   ...
   *
   * @param kerros Kerros, jonka varia halutaan vaihtaa. Kerroksien numerointi
   * alkaa pohjalta ykkösestä.
