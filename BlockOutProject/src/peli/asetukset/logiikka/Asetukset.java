...
public class Asetukset {
  ...
  /**
   * Hallinnoi yhta settia asetuksia. Sisaltaa seka pelin parametreja etta pelin
   * grafiikkaan ja pelaamiseen liittyvia valintoja.
   */
  ...
  /**
   * Asettaa merkkijonon perusteella asetuksiin palikkasetin, jolla tullaan
   * pelaamaan.
   *
  ...
  /**
   * Antaa asetuksiin tallennetut ulottuvuudet (pelin leveys, korkeus, syvyys,
   * pelin seinamien leikkauspisteen etaisyys)
   *
   * @return Ulottuvuudet
   */
  ...
  /**
   * Antaa asetuksien varisetin eli tiedon siita milla vareilla mitakin kerrosta
   * pelissa varitetaan.
   *
