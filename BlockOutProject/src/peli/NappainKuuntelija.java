...
public class NappainKuuntelija implements KeyListener {
  ...
  /**
   * Kuuntelee nappaintapahtumia pelissa ja valittaa niita pelin kautta
   * tippuville palikoille.
   *
   * @param peli Peli, jolle kuunnellaan nappaintapahtumia
   * @param kayttis Kayttoliittyma, jolle voidaan kertoa pelin paattymisesta kun
   * kayttaja on hyvaksynyt havion
