...
public class Ennatyslistaaja extends Ikkuna {
  ...
  /**
   * Vaihtaa listapanelissa nakyvaa listaa kuilukohtaisen ja yleisen listan
   * valilla.
   *
  ...
  /**
   * Saataa ennatyslistan parametrit tietylle peliasetukselle, jolloin voidaan
   * nayttaa kyseisen pelin ennatyslista.
   *
   * @param leveys Pelin kuilun leveys ruutuina
   * @param korkeus Pelin kuilun korkeus ruutuina
   * @param syvyys Pelin kuilun syvyys ruutuina
  ...
  /**
   * Palauttaa tiedon siita onko ennatyslistaaja kysymassa listaennatyksen
   * nimea.
   *
  ...
  /**
   * Vahvistaa annetun nimen ja lisaa sen kuilukohtaiselle listalle ja yleiselle
   * listalle jos annettu nimi ei ole tyhja.
   */
