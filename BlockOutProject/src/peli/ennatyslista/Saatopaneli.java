...
public class Saatopaneli extends JPanel {
  ...
  /**
   * Saataa ennatyslistanakymassa nakyvaa kuilukohtaista ennatyslistaa sen
   * mukaisesti minka kokoisen ja palikkasettisen kuilun ennatyslistaa kayttajaa
   * haluaa katsella.
   *
   * @param ennatyslistaaja Ennatyslistaaja, jonka nayttamia ennatyslistoja
   * vaihdellaan
   */
