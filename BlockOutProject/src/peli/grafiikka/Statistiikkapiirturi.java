...
public class Statistiikkapiirturi {
   ...
   *
   * @param tietopalkinLeveys Tiedoille varatun palkin leveys pelin kummallakin
   * puolella
  ...
  /**
   * Asettaa pelin kerrosten uudet varit myos kerrosnakymaan missa naytetaan
   * missa kuilun kerroksissa on paloja.
   *
