...
public class PyoritysAjastin extends Timer implements ActionListener {
  ...
  /**
   * Vastaanottaa ajastimen tapahtuman. Pyorayttaa tippuvaa palikkaa oikeampaa
   * suuntaan jos tippuva palikka on yha sama eika se ole tippunut pohjalle.
   * Nollaa kuvan viiveen jos peli on tauolla.
   *
