...
public class PalikkaPyorayttaja {
   ...
   * @param x Jos annettu arvo on -1 pyoritetaan vasen puoli esille, jos se on 1
   * pyoritetaan oikea puoli esille, jos nolla niin ei pyoriteta y-akselin
   * ympari
   * @param y Jos annettu arvo on -1 pyoritetaan ylapuoli esille, jos jos se on
   * 1 pyoritetaan alapuoli esille, jos nolla niin ei pyoriteta x-akselin ympari
   *
