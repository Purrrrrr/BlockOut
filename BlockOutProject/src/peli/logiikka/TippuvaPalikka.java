...
public class TippuvaPalikka extends PalikkaKentalla {
  ...
  //*******************************************
  /**
   * Siirtaa kayttajan toimien perusteella tippuvaa palikkaa kun se on
   * mahdollista.
   *
  ...
  /**
   * Siirtaa kayttajan tai pelin perusteella tippuvaa palikkaa kun se on
   * mahdollista.
   *
   * @param dx Siirrettava matka x-suunnassa
   * @param dy Siirrettava matka y-suunnassa
  ...
  //*******************************************
  /**
   * Kayttajan pyoritettya palikkaa se siirtyy valittomasti minka takia piirtaja
   * on toteutettu toimimaan viiveella. Kulmat dAlfaXY, dAlfaYZ ja dAlfaXZ
   * kertovat kulman minka verran kuva on jaljessa todellisuutta missakin
   * tasossa. Tama metodi oikaisee kuvaa hieman todellisuuden suuntaan aina kun
   * sita kutsutaan.
   */
