...
public class PalaMatriisi {
	...
	public boolean equals(Object other) {
		if (!(other instanceof PalaMatriisi)) return false;
		
		return this.equals((PalaMatriisi)other);
	}
	public boolean equals(PalaMatriisi that) {
		if (this.annaLeveys() != that.annaLeveys()) return false;
		if (this.annaKorkeus() != that.annaKorkeus()) return false;
		if (this.annaSyvyys() != that.annaSyvyys()) return false;
