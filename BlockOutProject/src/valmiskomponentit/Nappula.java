...
public class Nappula extends JButton {
  ...
  /**
   * Luo JButtonin, jonka ulkonakoa on muutettu. Kayttaja valitsee tekstin ja
   * taustan varin.
   *
   * @param teksti Teksti, joka nappulaan halutaan
   ...
   * @param fontinKoko Fontin koko, jonka kokoinen tai jota pienempi fontin
   * tulee olla
   */
  ...
  /**
   * Asettaa nappulan leveydelle kavennuksen minka verran nappulaa kavennetaan
   * seka oikealta, etta vasemmalta
   *
  ...
  /**
   * Asettaa nappulan aktiivisuuden. Normaaliin JButtoniin verrattuna muuttaa
   * myos nappulan tekstin ja taustan varit tummemmiksi.
   *
