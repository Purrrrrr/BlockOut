...
public class BlockOut implements Runnable {
  ...
  /**
   * Aloittaa pelin ja lopettaa ensin edellisen pelin jos se on viela kaynnissa.
   * Vaihtaa ikkunaksi peli-ikkunan
   */
  ...
  /**
   * Asettaa pelin tarvittaessa tauolle. Nain voi kayda jos peli on kaynnissa ja
   * pelaaja avaa jonkun muun ikkunan peli-ikkunan tilalle
   *
   * @param nytValittuIkkuna Ikkuna, jota ollaan vaihtamassa nykyisen ikkunan
   * tilalle
   */
  ...
  /**
   * Asettaa kaynnissa olevan pelin tauolle tai pois tauolta. Vaihtaa myos
   * Tauko-nappulan tekstin tasmaavaksi.
   *
  ...
  /**
   * Lopettaa kaynnissa olevan pelin. Avaa ennatyslistan jos pelin tulos on
   * paasemassa sille. Avaa tyhjan ikkunan jos nakymassa oli peli. Muuten ei
   * vaihda ikkunaa.
   */
