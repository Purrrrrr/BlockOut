...
public class NappainKuuntelija implements KeyListener {
  ...
  /**
   * Nappainkuuntelija, joka valittaa saamansa tapahtumat kayttoliittyman
   * aktiivisen ikkunan nappainkuuntelijalle.
   *
  ...
  /**
   * Antaa nappaintapahtuman edelleen kayttoliittyman aktiivisen ikkunan
   * nappainkuuntelijalle.
   *
