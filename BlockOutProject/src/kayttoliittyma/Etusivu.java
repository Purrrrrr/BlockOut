...
public class Etusivu extends JPanel {
  ...
  /**
   * Hallinnoi kayttoliittyman alalaidassa olevia nappuloita, joilla pelin voi
   * aloittaa, lopettaa ja laittaa tauolle tai ennatyslistaa tai asetuksia voi
   * katsella.
   *
  ...
  /**
   * Vaihtaa nappuloiden aktiivisuuksia sen mukaisiksi mika nakyma kayttajalla
   * on aktiivisena ja missa tilassa peli on
   *
  ...
  private static class TaukoNappulaKuuntelija implements ActionListener {
     ...
     *
     * @param kayttis Kayttoliittyma, johon nappula on kiinnitetty ja jota
     * nappulalla kaytetaan
    ...
    /**
     * Selvittaa kuuntelijan saamien tapahtumien perusteella laitetaanko tauko
     * paalle vai pois.
     *
  ...
  private static class UusiPeliNappulaKuuntelija implements ActionListener {
     ...
     *
     * @param kayttis Kayttoliittyma, jossa nappula on ja jota halutaan
     * nappulalla kayttaa
     */
  ...
  private static class AsetuksetNappulaKuuntelija implements ActionListener {
    ...
    /**
     * Tapahtuman perusteella vaihtaa kayttoliittyman nakyman ikkunan
     * asetuksiksi
     *
     * @param ae Tapahtuma
     */
  ...
  private static class EnnatyslistaNappulaKuuntelija implements ActionListener {
    ...
    /**
     * Tapahtuman perusteella vaihtaa kayttoliittyman nakymassa ikkunaksi
     * ennatyslista-ikkunan.
     *
     * @param ae Tapahtuma
     */
    @Override
